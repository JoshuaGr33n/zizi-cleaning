        ...
        <main class="content">
            ...
            <table class="user-profile-table">
                <tbody>
                    <tr>
                        <th></th>
                        <td><router-link to="/"><img :src="logo" alt="Logo" class="logo"></router-link>
                        </td>
                    </tr>
                    <tr>
                        <th>Client</th>
        ...
        getAppointment(appointmentId) {
            this.$store.dispatch('fetchAppointmentDetails', appointmentId)
                .then(response => {
                    ...
                    if (!this.appointmentDetails.extras_2 || typeof this.appointmentDetails.extras_2 !== 'object') {
                        this.appointmentDetails.extras_2 = {};
                    }
