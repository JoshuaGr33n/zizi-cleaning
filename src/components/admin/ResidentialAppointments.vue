<template>
    ...
    <div class="admin-panel">
        ...
        <div class="main-content">
            <AdminHeaderComponent>Residential Appointments({{ unreadCount }})</AdminHeaderComponent>
            <main class="content">
...
export default {
    ...
    data() {
        return {
            ...
            // appointments: [
            //     // Sample data
            //     { id: 1, date: '2023-03-30', status: 'pending' },
            //     { id: 2, date: '2023-04-05', status: 'complete' },
    ...
    created() {
        this.$store.dispatch('fetchResidentialAppointments');
    ...
    computed: {
        ...
        appointments() {
            return this.$store.state.residentialAppointments;
        },
        totalPages() {
            const appointments = Array.isArray(this.appointments) ? this.appointments : [];
            const filtered = appointments.filter(appointment => {
    ...
    methods: {
        ...
        detailPage(appointment) {
            ...
            this.$router.push({ name: 'ResidentialAppointmentDetail', params: { id: appointmentId } });
        },
    },
};
</script>
